...
func _ready():
	...
	item_list[Types.Item.Sawmill] = GameItemCraftingStation.new(Vector2i(0, 0), 2, Types.Item.Sawmill, 1, true, "Sawmill", Vector2i(0, 2), true)
	...
	item_list[Types.Item.Furnace] = GameItemCraftingStation.new(Vector2i(0, 0), 5, Types.Item.Furnace, 1, true, "Furnace", Vector2i(0,5), true)
