...
func _ready():
	...
	item_list[Types.Item.Chest] = GameItemPlaceable.new(Vector2i(0,0), 3, Types.Item.Chest, 1, true, "Chest", Vector2i(11,2), true)
	item_list[Types.Item.Bone] = GameItem.new(Vector2i(11,1), 4, Types.Item.Bone, 1, false, "Bone", Vector2i.ZERO, false)
	item_list[Types.Item.BoneTurret] = GameItemPlaceable.new(Vector2i(0,0), 6, Types.Item.BoneTurret, 1, true, "Bone Turret", Vector2i(14,2), true)
